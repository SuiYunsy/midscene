...
Corresponding to TypeScript source: packages/core/src/ai-model/prompt/describe.ts
"""
...
def element_describer_instruction() -> str:
    """Generate instruction for element description
    
    Returns:
        Element describer instruction prompt
    """
    preferred_language = get_preferred_language()
    
    return f"""
Describe the element in the red rectangle for precise identification. Use {preferred_language}.
