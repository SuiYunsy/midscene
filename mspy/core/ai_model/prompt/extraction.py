...
Corresponding to TypeScript source: packages/core/src/ai-model/prompt/extraction.ts
"""
...
def system_prompt_to_extract() -> str:
    """Generate system prompt for data extraction
    
    Returns:
        System prompt string for extraction
    """
    return """
...
def extract_data_query_prompt(
    ...
    """Generate prompt for data extraction query
    
    Args:
        page_description: Description of the page
        data_query: Data query (string or dict)
